export const APP_VERSION = "v51.4.3-pwa-install-fix";
...
export const STORAGE_KEYS = { session: "realstock.v51_4_3.session", draft: "realstock.v51_4_3.draft", cachePrefix: "realstock.v51_4_3.cache." };
