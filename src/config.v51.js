...
export const MODE_META = {
  ...
  issue: { label: "🔵 เบิกของ", color: "issue", saveLabel: "บันทึกการเบิก", helper: "บันทึกรายการเบิกอย่างเดียว ไม่ตัด stock ทันที" },
  receive: { label: "🟠 รับของ", color: "receive", saveLabel: "บันทึกรับของ", helper: "ใช้กรอกของที่รับเข้าจริง ระบบจะอัปเดต view หลัง nightly 22:00" },
