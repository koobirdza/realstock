export const APP_VERSION = "v51.4.2-data-fix-cache-fix";
...
export const STORAGE_KEYS = { session: "realstock.v51_4_2.session", draft: "realstock.v51_4_2.draft", cachePrefix: "realstock.v51_4_2.cache." };
