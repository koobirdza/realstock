import { CACHE_TTL, GOOGLE_SCRIPT_URL, SAVE_TIMEOUT_MS } from "./config.v50.js";
import { getCache, setCache, clearCache } from "./store.v50.js";
import { withTimeout } from "./utils.v50.js";
...
export const versions = () => getJson("versions", {}, "versions.runtime", CACHE_TTL.versions);
export const diagnostics = () => getJson("diagnostics", { admin: 1 }, "diagnostics.admin", CACHE_TTL.diagnostics);
