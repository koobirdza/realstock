import { AUTOSAVE_DEBOUNCE_MS, ENABLE_SERVICE_WORKER, SAVE_TIMEOUT_MS } from "./config.v45.js";
import { restoreSession, saveSession, clearSession } from "./auth.v45.js";
import { saveDraft, clearDraft, readDraft } from "./store.v45.js";
import { state, resetNavigation, setEmployee, setMode } from "./state.v45.js";
import { bindDom, dom, renderMode, renderNavigation, renderSession, setHealth, setDraftBadge, showFatalError, showInlineError, clearInlineError, toast } from "./ui.v45.js";
import { getNodeByPath, getRootNode } from "./catalog.v45.js";
import { collectRecords } from "./inventory.v45.js";
import { pingServer, submitRecords, getCatalog, exportDebugLog, getCurrentStockSummary, getDailySnapshot, testLineOA, exportLineTargets, getOrderView, refreshLineSummary, previewLineSummary, sendLineSummary } from "./api.v45.js";
import { debounce } from "./utils.v45.js";
...
async function loadCatalogs() {
  for (const mode of ["count", "issue", "order", "receive"]) await loadCatalogForMode(mode);
}
...
async function prepareMode(mode) {
  ...
  if (mode !== "order") await loadStockSummary();
