import { MAX_QTY } from "./config.v50.js";
import { state } from "./state.v50.js";
import { getItems } from "./catalog.v50.js";
import { nowIso, todayIso, parseNumber } from "./utils.v49.js";
...
export function collectRows(node, values) {
  ...
  if (!rows.length) {
    const msg = state.mode === "count" ? "กรุณากรอกยอดคงเหลืออย่างน้อย 1 รายการ" :
