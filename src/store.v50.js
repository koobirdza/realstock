import { STORAGE_KEYS } from "./config.v50.js";
...
export function setRuntime(value) {
  localStorage.setItem(STORAGE_KEYS.runtime, JSON.stringify({ value, savedAt: Date.now() }));
}
export function getRuntime() {
  try { return JSON.parse(localStorage.getItem(STORAGE_KEYS.runtime) || "null"); }
  catch (err) { return null; }
}
